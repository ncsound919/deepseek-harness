...
3. **Review the candidate**: read the generated SKILL.md; edit the protocol section so steps generalize beyond the original task before committing it to `.agents/skills/`.
